...
#include "Headers/proc_fs.h"
#include "Headers/string.h"

#include "Headers/vmaloc.h"
#include "Headers/skbuff.h"
#include "Headers/sched.h"
#include "Headers/netfilter.h"
#include "Headers/uaccess.h"
#include "Headers/if_ether.h"
#include "Headers/ip.h"
#include "Headers/tcp.h"
#include "Headers/udp.h"
#include "Headers/icmp.h"
#include "Headers/netfilter_ipv4.h"		// has the netfilter hook's structure
#include "minifw.h"     
...
int init_minifw_read_write_module(void) {
	...
	if(!my_ipt)														// check whether null pointer is returned for my_ipt
		...
		proc_entry = proc_entry("minifw", 0646, NULL);		// rw-r--rw-, the owner of this entry would have read/write permissions
		if(proc_entry == NULL) {
			ret = -ENOMEM;
			vfree(my_ipt);
